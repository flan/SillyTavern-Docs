...
| `{{outlet::(name)}}` | Replaced with the content of the named [World Info outlet](/Usage/World_Info/worldinfo.md#outlet-name), will contain activated entries separated by newlines. |
